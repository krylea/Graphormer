...
@register_model("graphormer3dsubshell")
class Graphormer3DSubshell(BaseFairseqModel):
    @classmethod
...
@register_model_architecture("graphormer3dsubshell", "graphormer3dsubshell_base")
