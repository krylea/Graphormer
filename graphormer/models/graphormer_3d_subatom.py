...
@register_model("graphormer3dsubatom")
class Graphormer3DSubatom(BaseFairseqModel):
    @classmethod
    ...
    def __init__(self, args):
        ...
        self.atom_embed.requires_grad = False
        ...
        self.dist_encoder = nn.Linear(self.args.embed_dim * 2, 2)
...
@register_model_architecture("graphormer3dsubatom", "graphormer3dsubatom_base")
